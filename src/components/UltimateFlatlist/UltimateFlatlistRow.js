 ...
 * If you are rendering a UltimateFlatlistRow explicitly you must pass the UltimateFlatlistRow exactly two children.
 ...
 */
class UltimateFlatlistRow extends Component {
  constructor(props) {
    super(props);
    this.isOpen = false;
  ...
  handlePanResponderEnd(e, gestureState) {
    ...
    if (this.isForceClosing) {
      setTimeout(() => {
        this.isForceClosing = false;
      }, 500); // 500 is the default Animated.spring's duration used in manuallyUltimateFlatlistRow
    }
  ...
  handleRightSwipe(projectedExtraPixels) {
    ...
    this.manuallyUltimateFlatlistRow(toValue, action);
  }
   ...
   */
  closeRow() {
    this.manuallyUltimateFlatlistRow(0);
  }
  ...
  manuallyUltimateFlatlistRow(toValue, onAnimationEnd) {
...
UltimateFlatlistRow.defaultProps = {
  leftOpenValue: 0,
  rightOpenValue: 0,
...
export default UltimateFlatlistRow;
